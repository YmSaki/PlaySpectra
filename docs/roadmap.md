...
- SteamVR Adapter: connect the driver skeleton in driver/ to the shared device core (`devicecore/`), replacing the skeleton's own ad-hoc protocol, then verify Windows runtime and application behavior.
