...
| SteamVR Adapter | **Planned** | driver/ contains an earlier skeleton. Connecting it to the shared device core (devicecore/) and Windows verification remain. Source: docs/steamvr-adapter.md. |
