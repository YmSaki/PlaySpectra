...
// Hooked functions.
// ---------------------------------------------------------------------------------------------
// NOTE: the frame-capture cluster (xrCreateSession/xrCreateSwapchain/xrDestroySwapchain/
// xrEnumerateSwapchainImages/xrAcquireSwapchainImage/xrReleaseSwapchainImage/xrEndFrame) now lives in
// hooks_capture.cpp; the dispatch table below still references those hooks by name.
...
// NOTE: the locate/reference-space cluster (xrLocateViews/xrCreateReferenceSpace/xrLocateSpace/
// xrLocateSpaces) now lives in hooks_locate.cpp; the dispatch table below still references those hooks
// by name. xrDestroySpace stays here with the teardown cluster (it also erases action-space tracking).
